/**
 * @file test_tftpqa_whitelist.c
 * @brief Unit tests for tftpqa_whitelist module.
 * @date Apr 20, 2026
...
void test_ipwhitelist_empty_is_deny_all(void)
{
   TEST_ASSERT_EQUAL_INT( -1, tftpqa_ipwhitelist_init("") );
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_is_deny_all() );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("1.2.3.4")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("255.255.255.255")) );
}

void test_ipwhitelist_is_deny_all_true(void)
{
   tftpqa_ipwhitelist_init("");
   TEST_ASSERT_TRUE( tftpqa_ipwhitelist_is_deny_all() );
}
...
void test_ipwhitelist_is_deny_all_false(void)
{
   ...
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("0.0.0.0/0") );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_is_deny_all() );
}

void test_ipwhitelist_single_bare_ip(void)
{
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("10.20.30.40") );
   // Bare IP is /32: only exact match admitted
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_contains(ipn("10.20.30.40")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("10.20.30.41")) );
}

void test_ipwhitelist_single_cidr_24(void)
{
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("192.168.1.0/24") );
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_contains(ipn("192.168.1.0")) );
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_contains(ipn("192.168.1.123")) );
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_contains(ipn("192.168.1.255")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("192.168.0.255")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("192.168.2.0")) );
}
...
void test_ipwhitelist_host_bits_normalized(void)
{
   ...
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("192.168.1.5/24") );
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_contains(ipn("192.168.1.0")) );
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_contains(ipn("192.168.1.5")) );
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_contains(ipn("192.168.1.200")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("192.168.2.5")) );
}

void test_ipwhitelist_mixed_list_with_whitespace(void)
{
   int rc = tftpqa_ipwhitelist_init(
      "  10.0.0.1 , 192.168.0.0/16,172.16.5.5/32 " );
   TEST_ASSERT_EQUAL_INT( 0, rc );
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_contains(ipn("10.0.0.1")) );
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_contains(ipn("192.168.200.7")) );
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_contains(ipn("172.16.5.5")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("10.0.0.2")) );
}

void test_ipwhitelist_prefix_zero_matches_all(void)
{
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("1.2.3.4/0") );
   TEST_ASSERT_TRUE( tftpqa_ipwhitelist_contains(ipn("8.8.8.8")) );
   TEST_ASSERT_TRUE( tftpqa_ipwhitelist_contains(ipn("0.0.0.0")) );
   TEST_ASSERT_TRUE( tftpqa_ipwhitelist_contains(ipn("255.255.255.255")) );
}
...
void test_ipwhitelist_prefix_32_explicit_vs_bare(void)
{
   ...
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("10.0.0.1/32") );
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_contains(ipn("10.0.0.1")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("10.0.0.2")) );
}
...
void test_ipwhitelist_overflow_rejected(void)
{
   ...
   TEST_ASSERT_EQUAL_INT( -1, tftpqa_ipwhitelist_init(buf) );
}
...
void test_ipwhitelist_malformed_results_in_deny_all(void)
{
   ...
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("10.0.0.1") );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_is_deny_all() );
   TEST_ASSERT_EQUAL_INT( -1, tftpqa_ipwhitelist_init("1.2.3.4/33") );
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_is_deny_all() );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("10.0.0.1")) );
}
...
void test_ipwhitelist_null_input_is_deny_all(void)
{
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("10.0.0.1") );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_is_deny_all() );
   TEST_ASSERT_EQUAL_INT( -1, tftpqa_ipwhitelist_init(NULL) );
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_is_deny_all() );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("10.0.0.1")) );
}
...
void test_ipwhitelist_malformed_trailing_comma(void)
{
   TEST_ASSERT_EQUAL_INT( -1, tftpqa_ipwhitelist_init("1.2.3.4,") );
}

void test_ipwhitelist_malformed_empty_middle_token(void)
{
   TEST_ASSERT_EQUAL_INT( -1, tftpqa_ipwhitelist_init("1.2.3.4,,5.6.7.8") );
}

void test_ipwhitelist_malformed_non_numeric_prefix(void)
{
   TEST_ASSERT_EQUAL_INT( -1, tftpqa_ipwhitelist_init("1.2.3.4/abc") );
}
...
void test_ipwhitelist_malformed_negative_prefix(void)
{
   TEST_ASSERT_EQUAL_INT( -1, tftpqa_ipwhitelist_init("1.2.3.4/-1") );
}

void test_ipwhitelist_malformed_bad_octet(void)
{
   TEST_ASSERT_EQUAL_INT( -1, tftpqa_ipwhitelist_init("999.0.0.1") );
}

void test_ipwhitelist_malformed_trailing_garbage(void)
{
   TEST_ASSERT_EQUAL_INT( -1, tftpqa_ipwhitelist_init("1.2.3.4abc") );
}
...
void test_ipwhitelist_malformed_double_slash(void)
{
   TEST_ASSERT_EQUAL_INT( -1, tftpqa_ipwhitelist_init("1.2.3.4/24/extra") );
}
...
void test_ipwhitelist_matcher_multiple_entries(void)
{
   TEST_ASSERT_EQUAL_INT( 0,
      tftpqa_ipwhitelist_init("10.0.0.1, 192.168.0.0/16, 172.16.5.5") );

   // First entry
   TEST_ASSERT_TRUE( tftpqa_ipwhitelist_contains(ipn("10.0.0.1")) );
   // Middle entry
   TEST_ASSERT_TRUE( tftpqa_ipwhitelist_contains(ipn("192.168.99.99")) );
   // Last entry
   TEST_ASSERT_TRUE( tftpqa_ipwhitelist_contains(ipn("172.16.5.5")) );
   // Not in whitelist
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("8.8.8.8")) );
}
 ...
 *
 * Each test begins with tftpqa_ipwhitelist_clear() so the blacklist — which
...
void test_ipwhitelist_block_whitelisted_ip_excluded(void)
{
   ...
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(ipn("10.0.0.1")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("10.0.0.1")) );
}
...
void test_ipwhitelist_block_non_whitelisted_ip_stays_false(void)
{
   ...
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(ipn("10.0.0.2")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("10.0.0.2")) );
...
{
   tftpqa_ipwhitelist_clear();
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("10.0.0.0/8") );

   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(ipn("10.1.2.3")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("10.1.2.3")) );
...
void test_ipwhitelist_block_invalid_inaddr_any(void)
{
   tftpqa_ipwhitelist_clear();
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("0.0.0.0/0") );
   TEST_ASSERT_EQUAL_INT( -1, tftpqa_ipwhitelist_block(htonl(INADDR_ANY)) );
}
...
void test_ipwhitelist_block_invalid_broadcast(void)
{
   tftpqa_ipwhitelist_clear();
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("0.0.0.0/0") );
   TEST_ASSERT_EQUAL_INT( -1, tftpqa_ipwhitelist_block(htonl(INADDR_BROADCAST)) );
}
...
void test_ipwhitelist_block_one_from_subnet(void)
{
   ...
   TEST_ASSERT_TRUE( tftpqa_ipwhitelist_contains(ipn("192.168.1.10")) );
   TEST_ASSERT_TRUE( tftpqa_ipwhitelist_contains(ipn("192.168.1.100")) );
   TEST_ASSERT_TRUE( tftpqa_ipwhitelist_contains(ipn("192.168.1.200")) );

   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(ipn("192.168.1.10")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("192.168.1.10")) );

   // Rest of subnet still accessible
   TEST_ASSERT_TRUE( tftpqa_ipwhitelist_contains(ipn("192.168.1.100")) );
   TEST_ASSERT_TRUE( tftpqa_ipwhitelist_contains(ipn("192.168.1.200")) );
   // Outside the subnet, still rejected
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("192.168.2.10")) );
}

void test_ipwhitelist_block_multiple_from_subnet(void)
{
   tftpqa_ipwhitelist_clear();
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("172.16.0.0/16") );

   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(ipn("172.16.0.1")) );
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(ipn("172.16.1.1")) );
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(ipn("172.16.2.1")) );

   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("172.16.0.1")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("172.16.1.1")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("172.16.2.1")) );

   // Non-blocked members of the subnet remain accessible
   TEST_ASSERT_TRUE( tftpqa_ipwhitelist_contains(ipn("172.16.0.2")) );
   TEST_ASSERT_TRUE( tftpqa_ipwhitelist_contains(ipn("172.16.5.5")) );
}
...
void test_ipwhitelist_block_subnet_boundary_ips(void)
{
   ...
   tftpqa_ipwhitelist_clear();
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("10.1.1.0/24") );

   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(ipn("10.1.1.0")) );
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(ipn("10.1.1.255")) );

   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("10.1.1.0")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("10.1.1.255")) );
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_contains(ipn("10.1.1.1")) );
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_contains(ipn("10.1.1.128")) );
}
...
void test_ipwhitelist_clear_resets_to_deny_all(void)
{
   ...
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_is_deny_all() );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("10.0.0.1")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("0.0.0.1")) );
}
...
void test_ipwhitelist_init_does_not_reset_blacklist(void)
{
   tftpqa_ipwhitelist_clear();
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("10.0.0.0/8") );
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(ipn("10.0.0.5")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("10.0.0.5")) );

   // Re-init with the same (or any) whitelist: blocked IP must stay blocked.
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("10.0.0.0/8") );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("10.0.0.5")) );
   // Other hosts in the subnet remain accessible
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_contains(ipn("10.0.0.6")) );
}
...
void test_ipwhitelist_block_forces_growth(void)
{
   ...
   for ( int i = 1; i <= 5; i++ )
   {
      ...
      blocked[i-1] = ipn(buf);
      TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(blocked[i-1]) );
   }

   for ( int i = 0; i < 5; i++ )
      TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(blocked[i]) );
...
void test_ipwhitelist_block_with_allow_all_whitelist(void)
{
   ...
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("0.0.0.0/0") );
   TEST_ASSERT_TRUE( tftpqa_ipwhitelist_contains(ipn("8.8.8.8")) );
   TEST_ASSERT_TRUE( tftpqa_ipwhitelist_contains(ipn("1.1.1.1")) );

   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(ipn("8.8.8.8")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("8.8.8.8")) );
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_contains(ipn("1.1.1.1")) );
}
 ...
 * tftpqa_ipwhitelist_clear() for state isolation.
 */
...
void test_ipwhitelist_is_deny_all_allow_all_with_blocked_ips(void)
{
   ...
   tftpqa_ipwhitelist_clear();
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("0.0.0.0/0") );
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(ipn("1.2.3.4")) );
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(ipn("5.6.7.8")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_is_deny_all() );
}
...
void test_ipwhitelist_is_deny_all_subnet_fully_shadowed(void)
{
   ...
   tftpqa_ipwhitelist_clear();
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("10.1.2.0/30") );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_is_deny_all() );

   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(ipn("10.1.2.0")) );
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(ipn("10.1.2.1")) );
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(ipn("10.1.2.2")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_is_deny_all() ); // .3 still live
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(ipn("10.1.2.3")) );
   TEST_ASSERT_TRUE( tftpqa_ipwhitelist_is_deny_all() );
}
...
void test_ipwhitelist_is_deny_all_subnet_partially_shadowed(void)
{
   ...
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_is_deny_all() );
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_contains(ipn("10.1.2.3")) );
}
...
void test_ipwhitelist_is_deny_all_multi_entry_all_shadowed(void)
{
   ...
   tftpqa_ipwhitelist_clear();
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("10.0.0.1, 10.0.0.2") );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_is_deny_all() );

   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_block(ipn("10.0.0.1")) );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_is_deny_all() ); // 10.0.0.2 still live
...
void test_ipwhitelist_is_deny_all_multi_entry_one_live(void)
{
   ...
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_is_deny_all() );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_contains(ipn("10.0.0.1")) );
   TEST_ASSERT_TRUE(  tftpqa_ipwhitelist_contains(ipn("10.0.0.2")) );
}
...
void test_ipwhitelist_clear_then_reblock_is_deny_all(void)
{
   ...
   tftpqa_ipwhitelist_clear();
   TEST_ASSERT_EQUAL_INT( 0, tftpqa_ipwhitelist_init("172.16.0.1") );
   TEST_ASSERT_FALSE( tftpqa_ipwhitelist_is_deny_all() );
